...
public class PersonController {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAll(
		...
		return ResponseEntity.ok(this.personServices.findAll(pageable));
	}
	...
	public PersonVO disablePerson(@PathVariable(value = "id") Long id) {
		return this.personServices.disablePerson(id);
	}
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonByName(
		...
		var sortDirection = "desc".equalsIgnoreCase(direction) ? Direction.DESC : Direction.ASC;
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName"));
		return ResponseEntity.ok(this.personServices.findPersonByName(firstName, pageable));
	}
}
